...
If you don't have an existing desire to fix or improve something already, there are some great resources available to get you pointed in the right direction. [First Timers Only](https://www.firsttimersonly.com/) is a project specifically aimed at highlighting opportunities for beginners to contribute to open source projects. There's a [great talk](https://www.youtube.com/watch?v=GWCcZ6fnpn4) from the React NYC conference on how someone used this kind of resource to contribute code to the React JS codebase which is currently one of the most popular web development tools used today.
