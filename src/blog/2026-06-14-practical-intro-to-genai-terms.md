...
<p>Claude Sonnet 4.6, named below as the model to try this on, has since been superseded by the Claude 5 family. Any current frontier model works for the demonstration — the point is about how these models work, not about that particular one. The authorship footnote at the end of this post names Sonnet 4.6 as a matter of historical record and is left as written.</p>
{% endcall %}
