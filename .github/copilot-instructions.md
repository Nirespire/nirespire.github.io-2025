...
- Always check the current branch before committing — never commit directly to `main`
- Create feature branches: `git checkout -b feature/description` or `git checkout -b bug/description`
